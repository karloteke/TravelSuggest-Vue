  ...
  <div class="max-w-6xl mx-auto px-4 py-8 mt-16">
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
      ...
      <button @click="handleAddUser"
        class="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-primary font-semibold rounded-full shadow-md hover:bg-gradient-to-r hover:from-accent-light hover:to-emerald-300 hover:text-white transition-all duration-300">
